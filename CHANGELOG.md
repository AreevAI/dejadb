...
_The first public release. DejaDB is pre-1.0; the on-disk `.mg` format and CAL
syntax are stable (OMS-conformant), but the Rust/Python API surface may still
change before `1.0`._
...
[Unreleased]: https://github.com/AreevAI/dejadb/commits/main
